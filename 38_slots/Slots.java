 ...
 * time spent: 0.6 hr
 ...
 DISCO:
 1) If you do (int)(Math.random() * x) you will get an int from 0 to x - 1
 2) You can't use BE == BE == BE.

 QCC:
 1) What is the purpose of toString()?
 *****************************************************/
...
public class Slots {
  ...
  public void spinOnce(){
    ...
    for(int i = 0; i < _fruits.length; i += 1){
      int x = (int)(Math.random() * _fruits.length);
      swap(i, x);
    }
  }
  ...
  public boolean miniWin(){
    ...
    else if ((_fruits[0] != _fruits[1]) && (_fruits[1] != _fruits[2]) && (_fruits[0] != _fruits[2])){
      retBoo = true;
    }
    return retBoo;
  }
