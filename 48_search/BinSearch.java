...
/*
DICSO:
1) When running a.compareTo(b), if a>b, it returns a positive num. If a<b, it returns a negative num. When a=b, it returns 0.
2) a and b cannot be ints, but can be Strings and Integers.
QCC:
1) What causes bad operand types?
2) When running this code, terminal tells me I have unchecked or unsafe operations. How can I fix that?
*/
