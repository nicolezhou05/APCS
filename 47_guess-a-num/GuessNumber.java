...
/*
DISCO:
1) Use break; to exit the loop immediately
2) Using while(true) can be helpful if you want to continuously run something.
QCC:
1) Are there other ways we can exit a loop that runs forever?
*/
